            ...
            <div class="row">
                ...
                <div class="col-5">
                    <div class="card mt-3 border-0">
                        ...
                        <ul class="ps-3">
                            <li><small>Nilai minimal tiap mata pelajaran tidak boleh di bawah 60</small></li>
                            <li><small>Nilai rata-rata tiap mata pelajaran tidak boleh di bawah 70</small></li>
                        </ul>
                    </div>
                </div>
            </div>
