...
<div id="layoutSidenav_content">
                            ...
                            ?>
                                <tr>
                                    ...
                                    <td align="center">
                                        ...
                                        <button type="button" class="btn btn-sm btn-danger" id="btnHapus" title="hapus guru" data-id="<?= $data['id'] ?>" data-foto="<?= $data['foto'] ?>"><i class="fa-solid fa-trash"></i></a>
                                    </td>
                                </tr>
                            <?php } ?>
                        </tbody>
    ...
    <!-- modal hapus data -->
    <div class="modal" id="mdlHapus" tabindex="-1" data-bsbackdrop="static">
