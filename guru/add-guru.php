...
if ($msg == 'cancel') {
  ...
  <i class="fa-solid fa-xmark"></i> Tambah Gagal, NIP sudah ada..
                                ...
                                <div class="mb-3 row">
                                    ...
                                    <div class="col-sm-9" style="margin-left: -50px;">
                                        <select name="agama" id="agama" class="form-select border-0 border-bottom" required>
                                            ...
                                            <option value="Islam-NU">Islam-NU</option>
                                            <option value="Islam-MD">Islam-MD</option>
                                            <option value="Islam-Syiah">Islam-Syiah</option>
