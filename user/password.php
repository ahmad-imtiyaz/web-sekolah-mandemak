...
$title = "Ganti Password - MAN Demak";
                    ...
                    <div class="card-body">
                        ...
                        <div class="mb-3 row">
                            <div class="col-7">
                                ...
                                <input type="password" class="form-control" id="newPass" minlength="4" maxlength="20" name="newPass" placeholder="Masukan password baru anda" required>
                            </div>
                        </div>
                        <div class="mb-3 row">
                            <div class="col-7">
